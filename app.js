...
// 	{
// 		name: "כפיפת ברכיים במכשיר סלקטור ייעודי",
// 		sets: 3,
// 		reps: 10,
// 		weight: "38 קילו",
// 		icon: "🦵",
...
// 	{
// 		name: "משיכת מוט לחזה כנגד פולי עליון",
// 		sets: 3,
// 		reps: 10,
// 		weight: "27 קילו",
// 		icon: "🔙",
...
// 	{
// 		name: "כפיפת מרפקים כנגד משקולות",
// 		sets: 3,
// 		reps: 7,
// 		weight: "5 קילו",
// 		icon: "💪",
...
// 		showPopup(
// 			"כל הכבוד! הגוף זוכר, השריר מגיב, והספה מחכה. מחר – אותו דבר, רק יותר חזק!"
// 		);
// 	}
// }
...
function toggleSet(setId, exerciseIndex) {
	...
	if (wasCompleted) {
		...
		completedSets.add(setId);
		showEncouragementPopup(exerciseIndex);
		startRestTimer(30); // ⏱️ מופעל בכל סימון סט
	}
...
function startRestTimer(seconds = 30) {
